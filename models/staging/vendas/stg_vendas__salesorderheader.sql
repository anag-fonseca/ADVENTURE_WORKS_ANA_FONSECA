...
renamed as (
    ...
    select
        ...
        cast(accountnumber as varchar) as salesorderheader_numero_conta,
        cast(customerid as int) as salesorderheader_cliente_id,
        cast(salespersonid as int) as salesorderheader_vendedor_id,
