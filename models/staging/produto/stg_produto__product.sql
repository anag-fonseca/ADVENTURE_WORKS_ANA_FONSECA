...
renamed as (
    ...
    select
        ...
        cast(makeflag as varchar) as product_makeflag,
        cast(finishedgoodsflag as varchar) as product_finishedgoodsflag,
        cast(color as varchar) as product_cor,
        cast(safetystocklevel as varchar) as product_safetystocklevel,
        cast(reorderpoint as varchar) as product_reorderpoint,
        cast(standardcost as varchar) as product_custo_padrao,
        cast(listprice as varchar) as product_lisa_preco,
        ...
        cast(daystomanufacture as varchar) as product_dias_producao,
