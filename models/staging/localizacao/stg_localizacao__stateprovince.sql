...
renamed as (
    ...
    select
        cast(stateprovinceid as varchar) as state_id,
        cast(stateprovincecode as varchar) as state_codigo,
        cast(countryregioncode as varchar) as state_codigo_regiao,
        cast(isonlystateprovinceflag as varchar) as state_isonlystateprovinceflag,
        cast(name as varchar) as state_nome,
        cast(territoryid as varchar) as state_territorio_id,
